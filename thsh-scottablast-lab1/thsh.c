...
int main(int argc, char **argv, char **envp) {
  ...
  while (!finished) {
    ...
    ret = run_command(parsed_commands[pipeline_steps], 0, 0, 0);
	//what parameters here
	//what parameters for execve
	//what purpose find_jobs has in run_command
	//what to use job_id for
